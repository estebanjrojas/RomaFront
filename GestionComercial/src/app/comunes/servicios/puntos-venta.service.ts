...
export class PuntosVentaService {
  ...
  getPuntosVentaBusqueda(texto_busqueda): Observable<any> {
    ...
    return this.http.get(
      environment.apiEndpoint + "/getPuntosVentaBusqueda/" + texto_busqueda,
      httpOptions
    );
  }
  ...
  getPuntosVentaTodos(): Observable<any> {
    ...
    return this.http.get(
      environment.apiEndpoint + "/getPuntosVentaTodos/",
      httpOptions
    );
  }
  ...
  getDatosPuntosVenta(id_punto_venta): Observable<any> {
    ...
    return this.http.get(
      environment.apiEndpoint + "/getDatosPuntosVenta/" + id_punto_venta,
      httpOptions
    );
  }
  ...
  insertCaracteristicasPuntoVenta(caract: any, punto_venta_id: number) {
    ...
    let json = JSON.stringify({
      tipo: caract.tipo,
      ultimo_nro: caract.ultimo_nro,
      por_defecto: caract.por_defecto,
  ...
  actualizarDatosPuntoVenta(datos: any): Observable<any> {
    ...
    return this.http.put(
      environment.apiEndpoint + "/actualizarDatosPuntoVenta",
      json,
      httpOptions
    );
  }
  ...
  eliminarCaracteristicasPuntoVenta(id_punto_venta: number) {
    ...
    const url =
      environment.apiEndpoint +
      `/eliminarCaracteristicasPuntoVenta/` +
      id_punto_venta;
