...
export class BusquedaVentasComponent implements OnInit {
  ...
  buscarVentas() {
    ...
    if (fecha == true) { buscar_por_fecha = 1; } else { buscar_por_fecha = 0; }
    if (nombre == true) { buscar_por_nombre = 1; } else { buscar_por_nombre = 0; }
    if (vendedor == true) { buscar_por_vendedor = 1; } else { buscar_por_vendedor = 0; }
    if (monto == true) { buscar_por_monto = 1; } else { buscar_por_monto = 0; }
