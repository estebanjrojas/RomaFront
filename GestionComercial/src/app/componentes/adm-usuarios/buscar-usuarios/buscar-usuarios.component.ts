...
export class BuscarUsuariosComponent implements OnInit {
  ...
  buscarUsuarios() {
    ...
    if (usuario == true) { buscar_por_usuario = 1; } else { buscar_por_usuario = 0; }
    if (descripcion == true) { buscar_por_descripcion = 1; } else { buscar_por_descripcion = 0; }
    this.SrvUsuarios.getCantidadPaginasUsuarios(buscar_por_nombre, buscar_por_usuario, buscar_por_descripcion, txtBuscar).subscribe(respuesta => {
  ...
  getItems() {
    ...
    if (usuario == true) { buscar_por_usuario = 1; } else { buscar_por_usuario = 0; }
    if (descripcion == true) { buscar_por_descripcion = 1; } else { buscar_por_descripcion = 0; }
    this.SrvUsuarios.getUsuarios(this.pagina_actual, this.cantidad_paginas, buscar_por_nombre, buscar_por_usuario, buscar_por_descripcion, txtBuscar).subscribe(respuesta => {
